...
const PrivacyElement = () => (
    <div className={styles.privacyBox}>
        ...
        <i>The Flowlence Privacy Policy was last updated: December 25, 2025</i>
        <p>
            Flowlence (&ldquo;Flowlence&rdquo;, &ldquo;we&rdquo; or &ldquo;us&rdquo;) understands how
        ...
        <ul>
            ...
            <li>
                <b>Legal</b> - We may use your Information to enforce our <a
                    href="https://flowlence.com/terms-of-use"
                    target="_blank"
                    rel="noopener noreferrer"
        ...
        <p>
            The Flowlence Team is a nonprofit organization. As such, the Children&apos;s Online Privacy
            Protection Act (COPPA) does not apply to Flowlence. Nevertheless, Flowlence takes children&apos;s privacy
            seriously. Flowlence collects only minimal information from its users, and only uses and discloses
            information to provide the services and for limited other purposes, such as research, as described in this
            Privacy Policy.
        </p>
        <p>
            Flowlence does not collect information from a student&apos;s education record, as defined by the Family
            Educational Rights and Privacy Act (FERPA). Flowlence does not disclose information of students to any third
        ...
        <ul>
            ...
            <li>
                ...
                provided in a contract between Flowlence and you, or (iii) if we have a compelling reason to do so (such
            ...
            <li>
                ...
                our servers, please contact <a
                    href="mailto:help@flowlence.com"
                    target="_blank"
                    rel="noopener noreferrer"
                >help@flowlence.com</a> for assistance.
            </li>
            <li>
        ...
        <p>
            ...
            the China. (where our Flowlence servers are located) or any other country in which we or our service
        ...
        <h2>Contact Us</h2>
        <p>
            The Flowlence Team is the entity responsible for the processing of your Information. If you have any
            questions about this Privacy Policy, or if you would like to exercise your rights to your Information, you
            may contact us at <a
                href="mailto:help@flowlence.com"
                target="_blank"
                rel="noopener noreferrer"
            >help@flowlence.com</a> or via mail at:
        </p>
        <div className="vcard">
            <div className="org">Flowlence</div>
